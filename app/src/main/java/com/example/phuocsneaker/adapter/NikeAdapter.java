...
public class NikeAdapter extends BaseAdapter {
    ...
    public class ViewHolder{
        public TextView txttenike,txtgianike,txtmotanike;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view ==  null){
            ...
            viewHolder.txttenike = view.findViewById(R.id.textviewnike);
            viewHolder.txtgianike = view.findViewById(R.id.textviewgianike);
            viewHolder.txtmotanike = view.findViewById(R.id.textviewmotanike);
            viewHolder.imgnike = view.findViewById(R.id.imageviewnike);
            view.setTag(viewHolder);
        }else {
            viewHolder = (ViewHolder) view.getTag();
        }
        Sanpham sanpham = (Sanpham) getItem(i);
        viewHolder.txttenike.setText(sanpham.getTensanpham());
        DecimalFormat decimalFormat = new DecimalFormat("###,###,###");
        viewHolder.txtgianike.setText("Giá : " + decimalFormat.format(sanpham.getGiasanpham())+ " Đ");
